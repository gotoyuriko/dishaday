<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="11_admin_recipe_approval.aspx.cs" Inherits="DishADay._11_admin_recipe_approval" %>
...
<body>
    ...
    <div class="admin-page">
        ...
        <form id="admin_recipe_approval_form" runat="server" class="admin-content">
            <div class="test">
            <h2>Recipe Approval</h2>
            <div class="admin-recipe-approval-content">
                <!-- === Yuriko Goto === -->
                <!-- recipe-content-wrap -->
