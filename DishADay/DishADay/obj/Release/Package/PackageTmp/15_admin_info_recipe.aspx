<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="15_admin_info_recipe.aspx.cs" Inherits="DishADay._15_admin_info_recipe" %>
...
<body>
    ...
    <div class="admin-page">
        ...
        <!--admin recipe info content-->
        <form id="admin_recipe_info_form" runat="server" class="admin-content">
            <div>
                <h2>Recipe Information</h2>
                <br />
                <div>
                    <asp:TextBox ID="adminRecipeInfoSearch" runat="server" type="search" placeholder="Search by name"></asp:TextBox>
                    <asp:Button ID="search_btn" runat="server" Text="Search" type="submit" class="admin-search-btn" OnClick="search_btn_Click" />
                </div>
                <br />
