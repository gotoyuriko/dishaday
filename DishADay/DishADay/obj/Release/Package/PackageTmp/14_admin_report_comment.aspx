<%@ page language="C#" autoeventwireup="true" codebehind="14_admin_report_comment.aspx.cs" inherits="DishADay._14_admin_report_comment" %>
...
<body>
    ...
    <div class="admin-page">
        ...
        <!-- ADMIN REPORTED COMMENTS CONTENT-->
        <form id="admin_report_comments_form" runat="server" class="admin-content">
            <div>
                ...
                <table class="table table-color table-striped">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">COMMENTED BY(USERNAME)</th>
