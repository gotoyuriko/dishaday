<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="16_admin_info_user.aspx.cs" Inherits="DishADay._16_admin_info_user" %>
...
<body>
    ...
    <div class="admin-page">
        ...
        <form id="admin_user_info_form" runat="server" class="admin-content">
            <div>
                <h2>User Information</h2>
                <br />
                <!-- search box -->
                <div>
                    <asp:TextBox ID="adminUserInfoSearch" runat="server" type="search" placeholder="Search by name"></asp:TextBox>
                    <asp:Button ID="search_btn" runat="server" type="submit" class="admin-search-btn" Text="Search" OnClick="search_btn_Click" />
                </div>
                <br />
                <!-- table -->
                <table class="table table-color table-striped">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">NUMBER OF RECIPE</th>
                        </tr>
                    </thead>
                    <tbody>
