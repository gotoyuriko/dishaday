<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="05_user_profile_cooking_history.aspx.cs" Inherits="DishADay._05_user_profile_cooking_history" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="profile-info-box">
            <div class="profile-info">
                ...
                <asp:Literal ID="userProfileLiteral" runat="server"></asp:Literal>
            </div>
        </div>
        ...
        <div class="profile-history-wrap">
            <asp:PlaceHolder ID="PlaceHolderClearHistory" runat="server"></asp:PlaceHolder>
            ...
            <div class="cooking-history">
                <table
                    ...
                    <tbody>
                        <asp:PlaceHolder ID="PlaceHolderCookingHistory" runat="server"></asp:PlaceHolder>
                    </tbody>
                </table>
            </div>
        </div>
