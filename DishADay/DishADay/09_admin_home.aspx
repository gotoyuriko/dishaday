<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="09_admin_home.aspx.cs" Inherits="DishADay._09_admin_home" %>
...
<body>
    ...
    <div class="admin-page">
        ...
        <form id="admin_home_form" runat="server" class="admin-content">
            <!--admin homepage content-->
            <div>
                <h2>Welcome back, <asp:Literal ID="Literal3" runat="server"></asp:Literal>!</h2>
                <br />
                <div class="row">
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <p class="card-text">
                                    ...
                                    </span> recipes pending approval
                                </p>
                                <a href="10_admin_recipe_approval_list.aspx" class="btn btn-primary">View</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="12_admin_enquiry.aspx" class="btn btn-primary">View</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <p class="card-text">
                                    ...
                                    </span> reported recipes
                                </p>
                                <a href="13_admin_report_recipe.aspx" class="btn btn-primary">View</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <p class="card-text">
                                    ...
                                    </span> reported comments
                                </p>
                                <a href="14_admin_report_comment.aspx" class="btn btn-primary">View</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <p class="card-text">
                                    ...
                                    </span> recipes uploaded
                                </p>
                                <a href="15_admin_info_recipe.aspx" class="btn btn-primary">View info</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="16_admin_info_user.aspx" class="btn btn-primary">View info</a>
                            </div>
                        </div>
                    </div>
                </div>
